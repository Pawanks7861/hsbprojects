      ...
      <div class="tab-content">
         ...
         <div role="tabpanel" class="tab-pane<?php if (!$this->input->get('tab')) {
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <?php
                  $last_vendor_code = get_last_vendor_code();

                  $next_vendor_code = str_pad($last_vendor_code + 1, 3, '0', STR_PAD_LEFT);
                  $vendor_code = (isset($client) ? $client->vendor_code : $next_vendor_code);
                  ...
                  <div id="vendor-exists-message">Vendor already exists.</div>
