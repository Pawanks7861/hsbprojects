...
function allow_vendors_to_register(invoker){
  ...
  function new_hsncode() {
    "use strict";
    $('.edit-title').addClass('hide');
    $('.add-title').removeClass('hide');
    $('#hsncode').modal('show');
    $('#additional_hsncode').html('');
  }

  function edit_hsncode(invoker,id) {
    "use strict";
    $('.edit-title').removeClass('hide');
    $('.add-title').addClass('hide');

    $('#additional_hsncode').html('');
    $('#additional_hsncode').append(hidden_input('id',id));

    $('#hsncode input[name="name"]').val($(invoker).data('name'));
    $('#hsncode textarea[name="description"]').val($(invoker).data('description'));
