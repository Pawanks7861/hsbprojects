...
function purchase_module_init_menu_items()
{
    ...
    if (is_admin()) {
        $CI->app_menu->add_sidebar_children_item('purchase', [
            ...
            'name' => _l('Payments'),
            'icon' => 'fa fa-credit-card',
            'href' => admin_url('purchase/pur_payments'),
            'position' => 12,
        ]);
    }
    ...
    if (has_permission('record_payment', '', 'view')) {
